 ...
 *
 */
// implementing this interface gives the dessert time new ability to watch and observe for life cycle changes
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    init {
        // setting observation relationship, this class now observes activity life cycle which is passed in constructor
